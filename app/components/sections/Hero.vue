<template>
      <section
        class="bg-hero-radial p-8 rounded-3xl xl:p-16 w-full mx-auto mb-4"
      >
        <div
          class="flex flex-col items-center gap-6 xl:flex-row xl:gap-8 xl:items-end mb-16"
        >
          <div class="flex-1 flex flex-col justify-start xl:grid xl:text-left">
            ...
            >
              ...
              <span class="text-[#01FEC7]"
                >Skup się na tym, co naprawdę ważne</span
              >
          ...
          >
            <img
              class="w-full h-auto max-h-[450px] max-w-[650px] object-contain relative z-10"
        ...
        >
          ...
          flotą i raportami finansowymi bez dziesiątek plików Excel. –
          gdziekolwiek jesteś.
        </p>
      </section>
</template>
